...
\begin{addmargin}[.6em]{.6em}
    ...
    % LunaID
    \textbf{LunaID} \\
    \textit{Mobile Application Developer Intern} \hfill \textit{Jan 2021 - Aug 2021}
    \begin{itemize}
        \item Developed \textbf{Android} and \textbf{iOS} apps to detect insects and recommend pesticides for agricultural farmers
        \item Constructed a data pipeline to annotate 36GB of image data for \textbf{Machine Learning} training
...
\begin{addmargin}[.6em]{.6em}
    ...
    \vspace{1.25em}
    % Password Manager
    \textbf{Password Manager} \hfill \myHref{https://git.io/J0mfM}{https://git.io/J0mfM}
    \begin{itemize}
    ...
    \vspace{1.25em}
    % % Kijiji scraper
    \textbf{Automated Classifieds Bot} \hfill \myHref{https://git.io/J0mf7}{https://git.io/J0mf7}
    \begin{itemize}
...
\begin{addmargin}[.6em]{.6em}
    \textbf{Languages: } Python, JavaScript, Java, HTML, CSS, C, Objective-C, Bash, SQL/NoSQL \\
    \textbf{Tools/Technologies: } Git, React/React Native, Docker, AWS,  Travis CI, Postman, CouchDB, Tensorflow
\end{addmargin}
\end{document}
